...
/**
 * Contains helper methods for testing patient commands.
 */
public class PatientCommandTestUtil {
    ...
    public static final String VALID_BIRTHDATE_AMY = "1998-04-03";
    public static final String VALID_BIRTHDATE_BOB = "1998-08-03";
    ...
    public static final String VALID_REMARK = "Test Remark";
