 ...
 * outside of the AppointmentDeleteCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the AppointmentDeleteCommand, and therefore we test only one of them.
