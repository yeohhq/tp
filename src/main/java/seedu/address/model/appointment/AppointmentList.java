 ...
 * As such, adding and updating of persons uses Appointment#isSameAppointment(Appointment)
 * for equality so as to ensure that the appointment being added or updated is
 * unique in terms of identity in the AppointmentList.
...
public class AppointmentList implements Iterable<Appointment> {
    ...
    /**
     * Adds an apointment to the list.
    ...
    public void setAppointments(seedu.address.model.appointment.AppointmentList replacement) {
